...
class MainS {
   ...
   public int main() {
      ...
      System.out.println("2. 추천도서 검색");
      System.out.println("3. 대출현황 조회");
      System.out.println("4. 도서 신청");
      System.out.println("5. 마이페이지");
      System.out.println("6. 대출 및 반납");
...
class MainM {
   ...
   public int main() {
      ...
      System.out.println("4. 연체현황 조회");
      System.out.println("5. 도서 신청 현황 조회 및 튜플 삭제");
      System.out.println("6. 학생정보수정");
      System.out.println("7. 로그아웃");
      System.out.print("============ 메뉴 선택 :");
      String view = ScanUtil.nextLine();
      switch (view) {
...
class MyPage {
   ...
   public int myPage() {
      ...
      System.out.println("1. 비밀번호 변경\t2. 예약 취소\t3. 뒤로 가기");
      System.out.print("============ 메뉴 선택 :");
      String view = ScanUtil.nextLine();
      switch (view) {
      case "1":
...
class RequestS{
   ...
   public int requestS() {
      ...
      System.out.println("============ 기능 선택 ============");
      System.out.println("1. 도서신청 현황 조회");
      System.out.println("2. 도서신청 삭제");
      System.out.print("============ 메뉴 선택 :");
      String view = ScanUtil.nextLine();
      switch (view) {
      case "1":
